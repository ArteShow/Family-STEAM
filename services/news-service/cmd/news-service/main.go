...
import (
	...
	"github.com/ArteShow/Family-STEAM/services/news-service/internal/config"
	"github.com/ArteShow/Family-STEAM/services/news-service/internal/handlers"
	"github.com/ArteShow/Family-STEAM/services/news-service/internal/middleware"
)
...
func main() {
	...
	mux.HandleFunc("/news-service/health", func(w http.ResponseWriter, _ *http.Request) {
