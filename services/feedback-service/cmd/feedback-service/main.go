...
import (
	...
	"github.com/ArteShow/Family-STEAM/services/feedback-service/internal/config"
	"github.com/ArteShow/Family-STEAM/services/feedback-service/internal/handlers"
	"github.com/ArteShow/Family-STEAM/services/feedback-service/internal/middleware"
)
...
func main() {
	...
	mux.HandleFunc("/feedback-service/health", func(w http.ResponseWriter, _ *http.Request) {
